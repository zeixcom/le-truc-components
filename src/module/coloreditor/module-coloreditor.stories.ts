...
const coloreditorTemplate = html`
  <module-coloreditor color="oklch(.48 .23 263)" name="Blue">
    ...
    <div class="info">
      <module-colorinfo class="lighten80">${colorInfoBlock()}</module-colorinfo>
      <module-colorinfo class="lighten60">${colorInfoBlock()}</module-colorinfo>
      <module-colorinfo class="lighten40">${colorInfoBlock()}</module-colorinfo>
      <module-colorinfo class="lighten20">${colorInfoBlock()}</module-colorinfo>
      ...
      <module-colorinfo class="darken20">${colorInfoBlock()}</module-colorinfo>
      <module-colorinfo class="darken40">${colorInfoBlock()}</module-colorinfo>
      <module-colorinfo class="darken60">${colorInfoBlock()}</module-colorinfo>
      <module-colorinfo class="darken80">${colorInfoBlock()}</module-colorinfo>
    </div>
  </module-coloreditor>
`;
